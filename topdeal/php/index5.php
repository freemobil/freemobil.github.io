...
<?php 
	...
	$footer5_css    = $scss->compile('@import "footer/footer2.scss"');
	...
	file_put_contents('css/footer/footer2.css', $footer5_css);
			...
			<header id="header" class=" typeheader-5">
				...
				<div class="header-center">
					<div class="container">
						<div class="row">
							<!-- LOGO -->
							<div class="header-logo col-lg-3 col-md-3 col-sm-4 col-xs-7">
								<a href="#"><img src="image/catalog/demo/logo/logo.png" title="Yourstore - Layout 2" alt="Yourstore - Layout 2" /></a>
							</div>
					...
					<div class="container">
						<div class="header-bottom-inner">
							<div class="row">
								...
								<div class="header-cart-phone col-lg-3 col-md-4 col-sm-3 col-xs-0">
							...
							<div class="row row-style row_klsd">
											...
											<div id="sohomepage-slider1">
												<div class="so-homeslider yt-content-slider full_slider owl-drag" data-rtl="yes" data-autoplay="yes" data-autoheight="no" data-delay="4" data-speed="0.6" data-margin="10" data-items_column00="1" data-items_column0="1" data-items_column1="1" data-items_column2="1"  data-items_column3="1" data-items_column4="1" data-arrows="no" data-pagination="yes" data-lazyload="yes" data-loop="yes" data-hoverpause="yes">
													<div class="item">
														...
														<img class="responsive" src="image/catalog/demo/slider/home5/slider-home21.jpg" alt="slide 1 - 1">
														</a>
													...
													<div class="item">
														...
														<img class="responsive" src="image/catalog/demo/slider/home5/slider-home22.jpg" alt="slide 1 - 2">
														</a>
														<div class="sohomeslider-description">
														</div>
													</div>
													<div class="item">
														...
														<img class="responsive" src="image/catalog/demo/slider/home5/slider-home23.jpg" alt="slide 1 - 3">
														</a>
														<div class="sohomeslider-description">
														</div>
													</div>
													<div class="item">
														...
														<img class="responsive" src="image/catalog/demo/slider/home5/slider-home24.jpg" alt="slide 1 - 4">
														</a>
														<div class="sohomeslider-description">
														</div>
													</div>
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 col_6p0e  block block_1">
									<div class="hashtags clearfix">
										...
										<ul class="clearfix"><li class="item col-md-15 col-sm-4 col-xs-4">
											<div class="item-image"><a title="Static Image" href="#"><img src="image/catalog/demo/banners/home5/cosmetic.png" alt="Static Image"></a></div>
											<div class="item-content">
											<h4><a href="#">#Cosmetics</a></h4>
											</div>
											</li>
											<li class="item col-md-15 col-sm-4 col-xs-4">
											<div class="item-image"><a title="Static Image" href="#"><img src="image/catalog/demo/banners/home5/hitech.png" alt="Static Image"></a></div>
											<div class="item-content">
											<h4><a href="#">#Hitech</a></h4>
											</div>
											</li>
											<li class="item col-md-15 col-sm-4 col-xs-4">
											<div class="item-image"><a title="Static Image" href="#"><img src="image/catalog/demo/banners/home5/menfashion.png" alt="Static Image"></a></div>
											<div class="item-content">
											<h4><a href="#">#Menfashion</a></h4>
											</div>
											</li>
											<li class="item col-md-15 col-sm-4 col-xs-4">
											<div class="item-image"><a title="Static Image" href="#"><img src="image/catalog/demo/banners/home5/shoes.png" alt="Static Image"></a></div>
											<div class="item-content">
											<h4><a href="#">#Shoes</a></h4>
											</div>
											</li>
											<li class="item col-md-15 col-sm-4 col-xs-4">
											<div class="item-image"><a title="Static Image" href="#"><img src="image/catalog/demo/banners/home5/womenfashion.png" alt="Static Image"></a></div>
											<div class="item-content">
											<h4><a href="#">#Womenfashion</a></h4>
											</div>
											</li>
											</ul>
							...
							<div class="row row-style row_ksdi">
														...
														<div class="item active">
															<div class="product-thumb transition">
																...
																<div class="caption">
																	...
																	<p class="des">【Neckband Designed】: Around-the-Neck Wearing Style With Body-contoured Fit. Made of ultra-light shape-memory alloy, great for easy carrying and all day comfort. Ensures a 100% comfortable fit especially when you are running, cycling, exercising and staying at home or in the Office.</p>
														...
														<div class="item">
															<div class="product-thumb transition">
																...
																<div class="caption">
																	...
																	<p class="des">Clip on the worlds most wearable music player and take up to 240 songs with you anywhere. Choose from five colors including four new hues to make your musical fashion statement.</p>
																	<div class="button-group">
																		<button class="bt-cart addToCart btn-button" type="button" data-toggle="tooltip" title="Add to Cart" onclick="cart.add('30');"> <span>Add to Cart</span></button>
																		<button class="bt wishlist btn-button" type="button" data-toggle="tooltip" title="Add to Wish List" onclick="wishlist.add('30');"><i class="fa fa-heart"></i></button>
																		<button class="bt compare btn-button" type="button" data-toggle="tooltip" title="Compare this Product" onclick="compare.add('30');"><i class="fa fa-exchange"></i></button>
								...
								<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 col_ksh4  block block_3 hidden-sm ">
									<div class="banner-layout-2 bn-2 clearfix">
										<div class="banners">
											<div>
												<a title="Static Image" href="#"><img src="image/catalog/demo/banners/home5/banner04.jpg" alt="Static Image"></a>
											</div>
										</div>
									</div>
								</div>
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 col_8djr  block block_4">
									<div class="trending clearfix">
										<div class="text col-md-2 col-sm-3 col-xs-4">
											<h3 class="title-block"><span>Trending</span> Categories</h3>
										</div>
										<div class="item col-md-10 col-sm-9 col-xs-8">
											<ul class="out-content contentslider" data-rtl="no" data-loop="no" data-autoplay="yes" data-autoheight="no" data-autowidth="no" data-delay="4" data-speed="0.6" data-margin="0" data-items_column0="6" data-items_column1="5" data-items_column2="4" data-items_column3="2" data-items_column4="1" data-arrows="yes" data-pagination="no" data-lazyload="yes" data-hoverpause="yes">
												...
												<li class="item item-3">
													<div class="item-content">
														<h4><a href="#">Jean</a></h4>
														<div class="product-count">4 Products </div>
													</div>
									...
									<div class="banner-layout-2 bt-4 clearfix">
										<div class="group-1 group">
											<div class="banner-6 banners">
												<div>
													...
													<img src="image/catalog/demo/banners/home5/home5_1.jpg" alt="Static Image">
													</a> 				
												</div>
											</div>
											<div class="banner-7 banners">
												<div>
													<a href="#" title="Banner 2">			
													<img src="image/catalog/demo/banners/home5/home5_2.jpg" alt="Static Image">
													</a> 				
												</div>
											</div>
										</div>
										<div class="group-2 group">
											<div class="banner-8 banners">
												<div>
													<a href="#" title="Banner 2">			
													<img src="image/catalog/demo/banners/home5/home5_3.jpg" alt="Static Image">
													</a> 				
												</div>
											</div>
										</div>
										<div class="group-3 group">
											<div class="banner-9 banners">
												<div>
													<a href="#" title="Banner 2">			
													<img src="image/catalog/demo/banners/home5/home5_4.jpg" alt="Static Image">
													</a> 				
												</div>
											</div>
											<div class="banner-10 banners">
												<div>
													<a href="#" title="Banner 2">			
													<img src="image/catalog/demo/banners/home5/home5_5.jpg" alt="Static Image">
													</a> 				
												</div>
											</div>
										</div>
										...
										<div class="modcontent">
											<div id="so_extra_slider_0372" class="so-extraslider buttom-type1 preset00-4 preset01-4 preset02-3 preset03-2 preset04-1 button-type1">
												<div class="box-banner">
													<div class="banners">
														<a title="Static Image" href="#"><img src="image/catalog/demo/banners/home5/banner-cat.jpg" alt="Static Image"></a>    
													</div>
												</div>
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 col_ks4m  block block_7">
									<div class="banner-layout-2 bn-2 clearfix">
										<div class="banners">
											<div>
												<a title="Static Image" href="#"><img src="image/catalog/demo/banners/home5/home5-6.jpg" alt="Static Image"></a>
											</div>
										</div>
									</div>
								</div>
