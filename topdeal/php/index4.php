...
$header4_css    = $scss->compile('@import "header/header4.scss"');
$footer1_css    = $scss->compile('@import "footer/footer1.scss"');
$responsive_css     = $scss->compile('@import "responsive.scss"');

file_put_contents('css/home4.css', $string_css);
file_put_contents('css/header/header4.css', $header4_css);
		...
		<div class="header-top hidden-compact">
			...
			<div class="row">
				...
				<div class="list-contact">
					<span class="hidden-sm"> Default welcome msg! </span> <a class="link-lg" href="register.html">Join Free</a> or  <a class="link-lg" href="login.html">Sign in</a>
				</div>
				</div>
			...
			<div class="container">
				<div class="row">
					<div class="navbar-logo col-lg-3 col-md-12 col-xs-12">
								<a href="index4.php"><img src="image/catalog/demo/logo/logo4.png" title="Your Store - Layout 4" alt="Your Store - Layout 4"></a>
							</div>
							...
							<div class="megamenu-wrapper">
								...
								<div class="container">
									...
									<li class="full-width menu-home with-sub-menu hover">
										...
										<div class="content" style="display: none; height: 450px;">
											<div class="row">
											<div class="col-sm-12">
												<div class="html ">
					...
					<div class="module sohomepage-slider so-homeslider-ltr  ">
						...
						<div id="sohomepage-slider1">
							...
							<div class="item">
								...
								<img class="responsive" src="image/catalog/demo/slider/home4/l1.jpg" alt="slide 1 - 1">
								</a>
							...
							<div class="item">
								...
								<img class="responsive" src="image/catalog/demo/slider/home4/l2.jpg" alt="slide 1 - 2">
								</a>
								<div class="sohomeslider-description">
								</div>
							</div>
							<div class="item">
								...
								<img class="responsive" src="image/catalog/demo/slider/home4/l3.jpg" alt="slide 1 - 3">
								</a>
								<div class="sohomeslider-description">
								</div>
							</div>
							<div class="item">
								...
								<img class="responsive" src="image/catalog/demo/slider/home4/l4.jpg" alt="slide 1 - 4">
								</a>
								<div class="sohomeslider-description">
								</div>
							</div>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 col_hmsd block block_2">
					<div class="home4-banner-1 row clearfix ">
						<div class="item-1 col-lg-4 col-md-4 col-sm-4 col-xs-6 mrb-30 banners">
							<div>
								<a title="Static Image" href="#"><img src="image/catalog/demo/banners/home4/banner4-1.jpg" alt="Static Image"></a>
							</div>
						</div>
						<div class="item-2 col-lg-4 col-md-4 col-sm-4 col-xs-6 mrb-30 banners">
							<div>
								<a title="Static Image" href="#"><img src="image/catalog/demo/banners/home4/banner4-2.jpg" alt="Static Image"></a>
							</div>
						</div>
						<div class="item-2 col-lg-4 col-md-4 col-sm-4 hidden-xs mrb-30 banners">
							<div>
								<a title="Static Image" href="#"><img src="image/catalog/demo/banners/home4/banner4-3.jpg" alt="Static Image"></a>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="ltabs-wrap">
							...
							<div class="ltabs-tabs-wrap">
								...
								<ul class="ltabs-tabs cf font-ct list-sub-cat">
									...
									<li class="ltabs-tab " data-category-id="4" data-active-content=".items-category-4"> <span class="ltabs-tab-label">New Arrivals</span> </li>
								</ul>
								</div>
							</div>
							<!-- End Tabs-->
																		...
																		<div class="product-item-container">
																			<div class="left-block">
																				<div class="image product-image-container ">
																					...
																					<img src="image/catalog/demo/product/book/8-370x370.jpg" alt="Bazem Carlo again is there anyone who loves oreos ">
																					</a>
																				</div>
																				<div class="box-label">
