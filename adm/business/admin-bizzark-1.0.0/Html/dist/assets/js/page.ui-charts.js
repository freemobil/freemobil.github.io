...
(function () {
  ...
  var Devices = function Devices(id) {
    ...
    var data = {
      ...
      datasets: [{
        data: [60, 25, 15],
        backgroundColor: [settings.colors.primary[600], settings.colors.success[300], settings.colors.success[100]],
