module.exports = function(grunt) {
    grunt.initConfig({
        ...
        uglify: {
          my_target: {
            files: {
                'assets/bundles/libscripts.bundle.js': ['assets/plugins/jquery/jquery-v3.2.1.min.js','assets/plugins/bootstrap/js/popper.min.js','assets/plugins/bootstrap/js/bootstrap.bundle.js'], /* main js*/
                ...
                'assets/bundles/flotscripts.bundle.js': [
                    ...
                    'assets/plugins/flot-charts/jquery.flot.time.js'], /* Flot Chart js*/ 
