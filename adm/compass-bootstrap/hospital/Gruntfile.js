        ...
        uglify: {
          my_target: {
            files: {
                ...
                'assets/bundles/vendorscripts.bundle.js': ['assets/plugins/bootstrap-select/js/bootstrap-select.js','assets/plugins/jquery-slimscroll/jquery.slimscroll.js','assets/plugins/node-waves/waves.js','assets/plugins/fullscreen/screenfull.js'], /* coman js*/
                'assets/bundles/mainscripts.bundle.js': ['assets/js/admin.js','assets/js/demo.js','assets/js/fullscreen.js'], /*coman js*/
                ...
                'assets/bundles/flotchartsscripts.bundle.js': ['assets/plugins/flot-charts/jquery.flot.js','assets/plugins/flot-charts/jquery.flot.resize.js','assets/plugins/flot-charts/jquery.flot.pie.js','assets/plugins/flot-charts/jquery.flot.categories.js','assets/plugins/flot-charts/jquery.flot.time.js'], /* Flot Chart js*/                
